package ru.sukhikh.telegramversion.UI.objects
...
import ru.sukhikh.telegramversion.UI.fragments.SettingsFragment
import ru.sukhikh.telegramversion.utilits.USER
import ru.sukhikh.telegramversion.utilits.downloadAndSetImage
        ...
        mDrawer = DrawerBuilder()
            ...
            .addDrawerItems(
                ...
                PrimaryDrawerItem().withIdentifier(104)
                    ...
                    .withName("Звонки")
                    .withSelectable(false)
                    .withIcon(R.drawable.ic_local_phone),
